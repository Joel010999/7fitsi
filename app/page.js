    ...
    <div className="home-wrapper">
      ...
      <section className="categories-section container">
        ...
        <div className="category-grid">
          <Link href="/mujer" className="category-card cat-mujer">
          ...
          <Link href="/hombre" className="category-card cat-hombre">
            <div className="category-card-bg"></div>
            <div className="category-card-content">
          ...
          <Link href="/unisex" className="category-card cat-unisex">
            <div className="category-card-bg"></div>
            <div className="category-card-content">
          ...
          <Link href="/giftcard" className="category-card cat-gift highlight">
            <div className="category-card-bg"></div>
            <div className="category-card-content">
      ...
      <section className="showcase-section">
        <div className="showcase-grid">
          <div className="showcase-item showcase-large">
            <img src="/images/sports_runner.png" alt="Atleta en acción" />
            <div className="showcase-overlay">
              <span>RENDIMIENTO</span>
            </div>
          </div>
          <div className="showcase-item showcase-small">
            <img src="/images/apparel_detail.png" alt="Detalle de tela deportiva" />
            <div className="showcase-overlay">
              <span>CALIDAD</span>
            </div>
          </div>
          <div className="showcase-item showcase-small">
            <img src="/images/sports_store_bg.png" alt="Tienda 7cero Sports" />
            <div className="showcase-overlay">
              <span>ESTILO</span>
            </div>
          </div>
      ...
      <section id="productos" className="catalog-section container">
        ...
        {products.length > 0 ? (
          ...
          <div className="empty-catalog">
            ...
            <h3>Próximamente</h3>
            <p>Estamos preparando nuevos productos para vos.<br/>¡Volvé pronto!</p>
          </div>
        )}
      </section>
      ...
      <section className="footer-cta">
        <div className="footer-cta-content container">
          ...
          <a href="https://wa.me/5491100000000" className="hero-btn primary" target="_blank" rel="noopener noreferrer">
